...
public class LoanApplicationController {
	...
	private UserAuthendicationService userAuthendicationService = new UserAuthendicationService();
	...
	public Boolean authendicateUser(String userId, String password) {
		return userAuthendicationService.authendicateUser(userId,password);
	}
}
